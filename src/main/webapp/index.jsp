	...
	<div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
	        <div class="carousel-item active" data-bs-interval="4000">
          		<img src="https://media.bunjang.co.kr/images/nocrop/1006977703_w1197.jpg" class="d-block w-100"/>
	        </div>
	        <div class="carousel-item" data-bs-interval="4000">
          		<img src="https://media.bunjang.co.kr/images/nocrop/1007175998_w1197.jpg" class="d-block w-100"/>
	        </div>
	        <div class="carousel-item" data-bs-interval="4000">
          		<img src="https://media.bunjang.co.kr/images/nocrop/1046725904_w1197.jpg" class="d-block w-100"/>
	        </div>
	        <div class="carousel-item" data-bs-interval="4000">
          		<img src="https://media.bunjang.co.kr/images/nocrop/1047713796_w1197.jpg" class="d-block w-100"/>
	        </div>
      	</div>
...
<section>
	...
	<div class="cate1">
		...
		<a href="<%=request.getContextPath()%>/headersearchcategory.do?categoryname=패션잡화">
			<div class="categoryLink">
				<div class="categoryBg">
		...
		<a href="<%=request.getContextPath()%>/headersearchcategory.do?categoryname=가전제품">
			<div class="categoryLink">
				<div class="categoryBg">
		...
		<a href="<%=request.getContextPath()%>/headersearchcategory.do?categoryname=PC/모바일">
			<div class="categoryLink">
				<div class="categoryBg">
